...
local LARViNChengUserName = database:get(bot_id.."LARViN:Cheng:UserName"..data.id_)
if not data.username_ then 
if LARViNChengUserName then 
send(msg.chat_id_, msg.id_, 1, "حذف معرفه خمطو بساع بساع  \n هاذه معرفه  : [@"..LARViNChengUserName..']')
database:del(bot_id.."LARViN:Cheng:UserName"..data.id_) 
end
end
...
database:set(bot_id.."LARViN:Cheng:UserName"..data.id_, data.username_) 
end
end
end
end,nil)   
